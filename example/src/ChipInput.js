...
function (_Component) {
  ...
  _createClass(ListPickerComponent, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_Button.default, {
      ...
      }, buttonText), _react.default.createElement(_Dialog.default, {
      ...
      }, pageBreak ? _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_Typography.default, {
        color: "primary",
        variant: "h6",
        component: "h6",
        style: {
      ...
      }, "Select Page"), _react.default.createElement(_Slider.default, {
        ...
        fullWidth: true
      }))), pageBreak ? _react.default.createElement(_DialogActions.default, null, _react.default.createElement(_Button.default, {
      ...
      }, "<"), _react.default.createElement(_Typography.default, null, "PAGE"), _react.default.createElement(_Button.default, {
        disabled: this.state.currentPage >= Math.ceil(data.length / pageBreak) - 1,
        onClick: function onClick() {
          return _this2.setState({
            currentPage: _this2.state.currentPage + 1
          });
        }
      }, ">")) : null, _react.default.createElement(_DialogActions.default, null, _react.default.createElement(_Button.default, {
        onClick: function onClick() {
          return _this2.setState({
            isOpen: false
          });
